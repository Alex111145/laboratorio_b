...
public class ServerDisconnectedController {
    ...
    /**
     * Gestisce l'evento di click sul pulsante di chiusura dell'applicazione.
     * Termina l'applicazione completamente, prima chiudendo l'interfaccia JavaFX
     * e poi uscendo dal processo Java.
     *
