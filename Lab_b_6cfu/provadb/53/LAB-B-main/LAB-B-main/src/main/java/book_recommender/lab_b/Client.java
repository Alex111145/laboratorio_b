...
public class Client extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            ...
            // Richiede all'utente di inserire i parametri di connessione
            boolean parametersProvided = getDatabaseConnectionParameters();
            if (!parametersProvided) {
                // Se l'utente annulla o non fornisce parametri validi, chiude l'applicazione
                Platform.exit();
                return;
            }
            ...
            connectionTask.setOnSucceeded(event -> {
                ...
                if (success) {
                    ...
                    // Mostra un avviso in caso di errore di connessione al database
